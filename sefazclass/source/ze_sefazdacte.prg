...
METHOD GeraFolha() CLASS hbnfeDaCte
   ...
   nLinhaRef := iif( ::nFolha == 1, 526, 220 )
      ...
      ::DrawTexto( 003, ::nLinhaPdf - ( nLinhaRef - 9 ), 590, Nil, "Documentos Originários", HPDF_TALIGN_CENTER, ::oPDFFontNormal, 8 )
      ...
      ELSE
         ::DrawTexto( 050, ::nLinhaPdf - nLinhaRef, 240, Nil, "CNPJ/CPF Emitente", HPDF_TALIGN_LEFT, ::oPDFFontNormal, 8 )
      ENDIF
      ::DrawTexto( 240, ::nLinhaPdf - nLinhaRef, 295, Nil, "Série/Nro. Doc.", HPDF_TALIGN_LEFT, ::oPDFFontNormal, 8 )
   ...
   ELSE
      ::DrawTexto( 345, ::nLinhaPdf - nLinhaRef, 535, Nil, "CNPJ/CPF Emitente", HPDF_TALIGN_LEFT, ::oPDFFontNormal, 8 )
   ENDIF
   ::DrawTexto( 535, ::nLinhaPdf - nLinhaRef, 590, Nil, "Série/Nro. Doc.", HPDF_TALIGN_LEFT, ::oPDFFontNormal, 8 )
   IF Len( ::aInfNFe ) > 0
      nLinha := nLinhaRef + 10
