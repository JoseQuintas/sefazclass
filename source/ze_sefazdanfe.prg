...
METHOD QuadroNotaFiscal() CLASS hbNFeDaNFe
   ...
   ENDIF
   ::nLinhaPdf -= 80
   ::DrawBoxTituloTexto( 5, ::nLinhaPdf, 365, 16, "NATUREZA DA OPERAÇÃO", ::FormataString( ::aIde[ "natOp" ], 360, 10 ), HPDF_TALIGN_LEFT, ::oPDFFontNormal, 10 )
   // PROTOCOLO
...
METHOD QuadroTransporte() CLASS hbNFeDaNFe
   ...
   IF ::nFolha == 1
      ...
      ::nLinhaPdf -= 6
      ::DrawBoxTituloTexto( 5, ::nLinhaPdf, 215, 16, "NOME/RAZÃO SOCIAL", ::FormataString( XmlToString( ::aTransp[ "xNome" ] ), 210, 8 ), HPDF_TALIGN_LEFT, ::oPDFFontNormal, 8 )
