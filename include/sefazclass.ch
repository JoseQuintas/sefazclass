...
#define WS_CTE_QRCODE { ;
   ...
   { "MT", "4.00P", "https://www.sefaz.mt.gov.br/cte/qrcode" }, ;
   { "MS", "4.00P", "http://www.dfe.ms.gov.br/cte/qrcode" }, ;
   { "MG", "4.00P", "https://portalcte.fazenda.mg.gov.br/portalcte/sistema/qrcode.xhtml" }, ;
   { "AP", "4.00P", "https://nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "PE", "4.00P", "https://nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "RR", "4.00P", "https://nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "AC", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "AL", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "AM", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "BA", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "CE", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "DF", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "ES", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "GO", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "MA", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PA", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PB", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PI", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RJ", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RN", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RO", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RS", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "SC", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "SE", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "TO", "4.00P", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   ;
   { "SP", "4.00H", "https://homologacao.nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "MT", "4.00H", "https://homologacao.sefaz.mt.gov.br/cte/qrcode" }, ;
   { "MS", "4.00H", "http://www.dfe.ms.gov.br/cte/qrcode" }, ;
   { "MG", "4.00H", "https://hcte.fazenda.mg.gov.br/portalcte/sistema/qrcode.xhtml" }, ;
   { "AP", "4.00H", "https://homologacao.nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "PE", "4.00H", "https://homologacao.nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "RR", "4.00H", "https://homologacao.nfe.fazenda.sp.gov.br/CTeConsulta/qrCode" }, ;
   { "AC", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "AL", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "AM", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "BA", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "CE", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "DF", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "ES", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "GO", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "MA", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PA", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PB", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "PI", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RJ", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RN", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RO", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "RS", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "SC", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "SE", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
   { "TO", "4.00H", "https://dfe-portal.svrs.rs.gov.br/cte/qrCode" }, ;
...
#define WS_NFE_QRCODE { ;
   ...
   { "DF",   "4.00H", "http://www.fazenda.df.gov.br/nfce/qrcode" }, ;
   ...
   { "PR",   "4.00H", "https://www.fazenda.pr.gov.br/nfce/qrcode" }, ;
   ...
   { "SC",   "4.00H", "https://hom.sat.sef.sc.gov.br/nfce/consulta"  }, ;
   ;
   ...
   { "CE",   "4.00P", "http://nfce.sefaz.ce.gov.br/pages/ShowNFCe.html" }, ;
   { "DF",   "4.00P", "http://www.fazenda.df.gov.br/nfce/qrcode" }, ;
   ...
   { "PR",   "4.00P", "https://www.fazenda.pr.gov.br/nfce/qrcode" }, ;
   ...
   { "SC",   "4.00P", "https://sat.sef.sc.gov.br/nfce/consulta" } }
...
#define WS_NFE_CHAVE { ;
   ...
   { "DF", "3.00H", "http://www.fazenda.df.gov.br/nfce/consulta" }, ;
   ...
   { "PR", "3.00H", "http://www.fazenda.pr.gov.br/nfce/consulta" }, ;
   ...
   { "SC", "2.00H", "https://hom.sat.sef.sc.gov.br/nfce/consulta" }, ;
   ;
   ...
   { "DF", "3.00P", "http://www.fazenda.df.gov.br/nfce/consulta" }, ;
   ...
   { "PR", "3.00P", "http://www.fazenda.pr.gov.br/nfce/consulta" }, ;
   ...
   { "SC", "2.00P", "https://sat.sef.sc.gov.br/nfce/consulta" } }
