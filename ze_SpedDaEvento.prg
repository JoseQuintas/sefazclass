...
METHOD Cabecalho() CLASS hbnfeDaEvento
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPdf + 2,     274, Nil, "IDENTIFICAÇÃO DO EMITENTE", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   // alert('nLogoStyle: ' + ::nLogoStyle +';_LOGO_ESQUERDA: ' + _LOGO_ESQUERDA)
   IF ::cLogoFile == NIL .OR. Empty( ::cLogoFile )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -6,  289, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 1 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -20,  289, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 2 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -42,  289, Nil, ::aEmit[ "xLgr" ] + " " + ::aEmit[ "nro" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -52,  289, Nil, ::aEmit[ "xBairro" ] + " - " + Transform( ::aEmit[ "CEP" ], "@R 99999-999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -62,  289, Nil, ::aEmit[ "xMun" ] + " - " + ::aEmit[ "UF" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -72,  289, Nil, iif( Empty( ::cTelefoneEmitente ), "", "FONE: " + ::cTelefoneEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -82,  289, Nil, Trim( ::cSiteEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
      hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -92,  289, Nil, Trim( ::cEmailEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
   ELSE
      ...
      ELSEIF ::nLogoStyle = _LOGO_ESQUERDA
         ...
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -6,  289, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 1 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -20, 289, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 2 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -42,  289, Nil, ::aEmit[ "xLgr" ] + " " + ::aEmit[ "nro" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -52,  289, Nil, ::aEmit[ "xBairro" ] + " - " + Transform( ::aEmit[ "CEP" ], "@R 99999-999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -62,  289, Nil, ::aEmit[ "xMun" ] + " - " + ::aEmit[ "UF" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -72,  289, Nil, iif( Empty( ::cTelefoneEmitente ), "", "FONE: " + ::cTelefoneEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -82,  289, Nil, Trim( ::cSiteEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  100, ::nLinhaPDF -92,  289, Nil, Trim( ::cEmailEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )

      ELSEIF ::nLogoStyle = _LOGO_DIREITA
         HPDF_Page_DrawImage( ::oPdfPage, oImage, 220, ::nLinhaPdf - ( 62 + 18 ), 62, 62 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -6,  218, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 1 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -20, 218, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 30, 2 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -42,  218, Nil, ::aEmit[ "xLgr" ] + " " + ::aEmit[ "nro" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -52,  218, Nil, ::aEmit[ "xBairro" ] + " - " + Transform( ::aEmit[ "CEP" ], "@R 99999-999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -62,  218, Nil, ::aEmit[ "xMun" ] + " - " + ::aEmit[ "UF" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -72,  218, Nil, iif( Empty( ::cTelefoneEmitente ), "", "FONE: " + ::cTelefoneEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -82,  218, Nil, Trim( ::cSiteEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
         hbNFe_Texto_hpdf( ::oPdfPage,  30, ::nLinhaPDF -92,  218, Nil, Trim( ::cEmailEmitente ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
      ENDIF
   ENDIF
...
/*
      IF EMPTY( ::cLogoFile )
          ...
          hbNFe_Texto_hpdf( ::oPdfPage, 71, ::nLinhaPDF - 54, 399, Nil, IF( Empty(::cTelefoneEmitente),"", "FONE: "+::cTelefoneEmitente), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 8 )
       ...
       ELSE
          ...
          ELSEIF ::nLogoStyle = _LOGO_DIREITA
            ...
            hbNFe_Texto_hpdf( ::oPdfPage, 71, ::nLinhaPDF - 54, 335, Nil, IF( Empty(::cTelefoneEmitente),"","FONE: "+::cTelefoneEmitente), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 8 )
...
*/
   ...
   IF ::aInfEvento[ "tpEvento" ] == "110110"
      hbNFe_Texto_hpdf( ::oPdfPage, 292, ::nLinhaPDF -2, 554, Nil, "CC-e", HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 18 )
      hbNFe_Texto_hpdf( ::oPdfPage, 296, ::nLinhaPDF -22, 554, Nil, "CARTA DE CORREÇÃO ELETRÔNICA", HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
   ELSE
      hbNFe_Texto_hpdf( ::oPdfPage, 292, ::nLinhaPDF -2, 554, Nil, "EVENTO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 18 )
      DO CASE
      CASE ::aInfEvento[ "tpEvento" ] == "110111"
         hbNFe_Texto_hpdf( ::oPdfPage, 296, ::nLinhaPDF -22, 554, Nil, "CANCELAMENTO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
      OTHERWISE
         hbNFe_Texto_hpdf( ::oPdfPage, 296, ::nLinhaPDF -22, 554, Nil, "EVENTO " + ::aInfEvento[ "tpEvento" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
      ENDCASE
   ENDIF

   // chave de acesso
   hbNFe_Box_Hpdf( ::oPdfPage, 290, ::nLinhaPDF -61,  275,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 291, ::nLinhaPDF -42, 534, Nil, "CHAVE DE ACESSO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   IF ::cFonteEvento == "Times"
      hbNFe_Texto_hpdf( ::oPdfPage, 292, ::nLinhaPDF -49, 554, Nil, Transform( ::cChaveEvento, "@R 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 10 )
   ELSE
      hbNFe_Texto_hpdf( ::oPdfPage, 292, ::nLinhaPDF -50, 554, Nil, Transform( ::cChaveEvento, "@R 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 8 )
   ENDIF
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf,      160, Nil, "CNPJ", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 31, ::nLinhaPDF -6,    160, Nil, Transform( ::aEmit[ "CNPJ" ], "@R 99.999.999/9999-99" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // I.E.
   hbNFe_Box_Hpdf(  ::oPdfPage, 160, ::nLinhaPDF -20,  130,  20, ::nLarguraBox )    // Quadro INSCRIÇÃO
   hbNFe_Texto_hpdf( ::oPdfPage, 162, ::nLinhaPdf,     290, Nil, "INSCRIÇÃO ESTADUAL", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 161, ::nLinhaPDF -6,   290, Nil, ::aEmit[ "IE" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // MODELO DO DOCUMENTO (NF-E)
   hbNFe_Texto_hpdf( ::oPdfPage, 291, ::nLinhaPdf,     340, Nil, "MODELO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 291, ::nLinhaPDF -6,   340, Nil, ::aIde[ "mod" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   ...
   ELSE
      // NUMERO NFE
      hbNFe_Texto_hpdf( ::oPdfPage, 391, ::nLinhaPdf,     480, Nil, "NUMERO DA NF-e", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
      hbNFe_Texto_hpdf( ::oPdfPage, 391, ::nLinhaPDF -6,   480, Nil, SubStr( StrZero( Val( ::aIde[ "nNF" ] ), 9 ), 1, 3 ) + "." + SubStr( StrZero( Val( ::aIde[ "nNF" ] ), 9 ), 4, 3 ) + "." + SubStr( StrZero( Val( ::aIde[ "nNF" ] ), 9 ), 7, 3 ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   ENDIF
   // DATA DE EMISSAO DA NFE
   hbNFe_Box_Hpdf( ::oPdfPage,  480, ::nLinhaPDF -20,   85,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 481, ::nLinhaPdf,     565, Nil, "DATA DE EMISSÃO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 481, ::nLinhaPDF -6,   565, Nil, SubStr( ::aIde[ "dhEmi" ], 9, 2 ) + '/' + SubStr( ::aIde[ "dhEmi" ], 6, 2 ) + '/' + Left( ::aIde[ "dhEmi" ], 4 ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
...
METHOD Destinatario() CLASS hbnfeDaEvento
   ...
   IF At( "retEventoCTe", ::cXmlEvento ) > 0  // runner
      hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPdf, 565, Nil, "DESTINATÁRIO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ELSE
      hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPdf, 565, Nil, "DESTINATÁRIO/REMETENTE", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ENDIF
   ::nLinhaPdf -= 9
   // RAZAO SOCIAL
   hbNFe_Box_Hpdf( ::oPdfPage,  30, ::nLinhaPDF -20, 425, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf, 444, Nil, "NOME / RAZÃO SOCIAL", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPDF -6, 444, Nil, ::aDest[ "xNome" ], HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 11 )
   // CNPJ/CPF
   hbNFe_Box_Hpdf( ::oPdfPage, 455, ::nLinhaPDF -20, 110, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 457, ::nLinhaPdf, 565, Nil, "CNPJ/CPF", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   IF ! Empty( ::aDest[ "CNPJ" ] )
      hbNFe_Texto_hpdf( ::oPdfPage, 457, ::nLinhaPDF -6, 565, Nil, Transform( ::aDest[ "CNPJ" ], "@R 99.999.999/9999-99" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   ELSE
      IF ::aDest[ "CPF" ] <> Nil
         hbNFe_Texto_hpdf( ::oPdfPage, 457, ::nLinhaPDF -6, 565, Nil, Transform( ::aDest[ "CPF" ], "@R 999.999.999-99" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
      ENDIF
   ENDIF
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf, 298, Nil, "ENDEREÇO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPDF -6, 298, Nil, ::aDest[ "xLgr" ] + " " + ::aDest[ "nro" ], HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 9 )
   // BAIRRO
   hbNFe_Box_Hpdf( ::oPdfPage, 300, ::nLinhaPDF -20, 195, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 302, ::nLinhaPdf, 494, Nil, "BAIRRO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 302, ::nLinhaPDF -6, 494, Nil, ::aDest[ "xBairro" ], HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 11 )
   // CEP
   hbNFe_Box_Hpdf( ::oPdfPage, 495, ::nLinhaPDF -20, 70, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 497, ::nLinhaPdf, 564, Nil, "C.E.P.", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 497, ::nLinhaPDF -6, 564, Nil, Transform( ::aDest[ "CEP" ], "@R 99999-999" ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   ::nLinhaPdf -= 20

   // MUNICIPIO
   hbNFe_Box_Hpdf( ::oPdfPage,  30, ::nLinhaPDF -20, 535, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf, 284, Nil, "MUNICIPIO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPDF -6, 284, Nil, ::aDest[ "xMun" ], HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 11 )
   // FONE/FAX
   hbNFe_Box_Hpdf( ::oPdfPage, 285, ::nLinhaPDF -20, 140, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 287, ::nLinhaPdf, 424, Nil, "FONE/FAX", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 287, ::nLinhaPDF -6, 424, Nil, FormatTelefone( ::aDest[ "fone" ] ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   // ESTADO
   hbNFe_Texto_hpdf( ::oPdfPage, 427, ::nLinhaPdf, 454, Nil, "ESTADO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 427, ::nLinhaPDF -6, 454, Nil, ::aDest[ "UF" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   // INSC. EST.
   hbNFe_Box_Hpdf( ::oPdfPage, 455, ::nLinhaPDF -20, 110, 20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 457, ::nLinhaPdf, 564, Nil, "INSCRIÇÃO ESTADUAL", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 457, ::nLinhaPDF -6, 564, Nil, ::aDest[ "IE" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
...
METHOD Eventos() CLASS hbnfeDaEvento
   ...
   // Eventos
   hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPDF -4, 565, Nil, "EVENTOS", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ...
   // ORGAO EMITENTE
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf,   90, Nil, "ORGÃO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPDF -6, 90, Nil, ::aInfEvento[ "cOrgao" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // TIPO DE EVENTO'
   hbNFe_Box_Hpdf( ::oPdfPage,  90, ::nLinhaPDF -20,   60,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 92, ::nLinhaPdf,     149, Nil, "TIPO EVENTO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 92, ::nLinhaPDF -6,   149, Nil, ::aInfEvento[ "tpEvento" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // SEQUENCIA  EVENTO
   hbNFe_Texto_hpdf( ::oPdfPage, 152, ::nLinhaPdf,   209, Nil, "SEQ. EVENTO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 152, ::nLinhaPDF -6, 209, Nil, ::aInfEvento[ "nSeqEvento" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // VERSÃO DO EVENTO
   hbNFe_Box_Hpdf( ::oPdfPage,  210, ::nLinhaPDF -20,   60,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 212, ::nLinhaPdf,      269, Nil, "VERSÃO EVENTO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 212, ::nLinhaPDF -6,    269, Nil, ::aInfEvento[ "verEvento" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // DATA E HORA DO REGISTRO
   hbNFe_Texto_hpdf( ::oPdfPage, 272, ::nLinhaPdf,  429, Nil, "DATA DO REGISTRO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 272, ::nLinhaPDF -6, 429, Nil, cDataHoraReg, HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   // NUMERO DO PROTOCOLO
   hbNFe_Box_Hpdf( ::oPdfPage,  430, ::nLinhaPDF -20,    135,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 432, ::nLinhaPdf,       564, Nil, "NUMERO DO PROTOCOLO", HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 432, ::nLinhaPDF -6,     564, Nil, ::aInfEvento[ "nProt" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )

   ::nLinhaPdf -= 20

   // STATUS DO EVENTO
   hbNFe_Box_Hpdf( ::oPdfPage,  30, ::nLinhaPDF -20,  535,  20, ::nLarguraBox )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPdf,     564, Nil, "STATUS DO EVENTO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 6 )
   hbNFe_Texto_hpdf( ::oPdfPage, 32, ::nLinhaPDF -6,    60, Nil, ::aInfEvento[ "cStat" ], HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   hbNFe_Texto_hpdf( ::oPdfPage, 62, ::nLinhaPDF -6,    564, Nil, ::aInfEvento[ "xMotivo" ], HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 11 )

   ::nLinhaPdf -= 25

   // Correções

   hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPdf, 565, Nil, "CORREÇÕES", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ...
   IF Len( ::aCorrecoes ) > 0
      ...
      FOR EACH oElement IN ::aCorrecoes
         ...
         hbNFe_Texto_hpdf( ::oPdfPage, 38, ::nLinhaPdf,564, Nil, 'Alterado = Grupo : '+cGrupo+' - Campo : '+cCampo+' - Valor : '+cValor , HPDF_TALIGN_LEFT, ::oPdfFontCorrecoes, 11 )
         ::nLinhaPdf -= 12
      NEXT
   ...
   ELSE
      ...
      FOR nI = 1 TO MLCount( cMemo, nCompLinha )
         hbNFe_Texto_hpdf( ::oPdfPage, 38, ::nLinhaPdf,564, Nil, Upper( Trim( MemoLine( cMemo, nCompLinha, nI ) ) ), HPDF_TALIGN_LEFT, ::oPdfFontCorrecoes, 11 )
         ::nLinhaPdf -= 12
      NEXT
...
METHOD Rodape() CLASS hbnfeDaEvento
   ...
   // Condição de USO
   hbNFe_Texto_hpdf( ::oPdfPage, 30, ::nLinhaPdf, 535, Nil, "CONDIÇÃO DE USO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   IF At("retEventoCTe",::cXmlEvento) > 0  // runner
      ...
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -12,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'utilização  de carta  de  correção, para  regularização  de  erro  ocorrido  na  emissão  de'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -24,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'documentos  fiscais  relativos à prestação de serviço  de  transporte, desde  que o erro não'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -36,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'esteja relacionado com :'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -48,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'I   - As variáveis que determinam o valor  do imposto  tais como: base de cálculo, alíquota,'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -60,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := '      diferença de preço, quantidade, da prestação;'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -72,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'II  - A correção de dados cadastrais que  implique mudança do emitente,  tomador,  remetente'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -84,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := '      ou do destinatário;'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -96,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      cTextoCond := 'III - A data de emissão ou de saída.'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPdf -108,564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, nTamFonte )
      // Observações:
        ::nLinhaPdf -= 124
   ELSE
   ...
   IF ::cFonteEvento == "Times"
      ...
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -12, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 15 )
      cTextoCond := 'cópia que acompanha, devendo  a  via  de  V.S(as) ficar juntamente com  a nota fiscal'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -26, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 15 )
      cTextoCond := 'em questão.'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -40, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 15 )
   ELSEIF ::cFonteEvento == "Helvetica"
      cTextoCond := 'Para evitar-se qualquer sansão fiscal, solicitamos acusarem  o  recebimento desta, '
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -12, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 14 )
      cTextoCond := 'na cópia que acompanha, devendo a via  de  V.S(as) ficar juntamente com  a  nota '
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -26, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 14 )
      cTextoCond := 'fiscal em questão.'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -40, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 14 )
   ELSE
      cTextoCond := 'Para evitar-se qualquer sansão fiscal, solicitamos acusarem o recebimento desta,'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -12, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 11 )
      cTextoCond := 'na cópia que acompanha, devendo a via  de  V.S(as) ficar juntamente com  a nota'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -26, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 11 )
      cTextoCond := 'fiscal em questão.'
      hbNFe_Texto_hpdf( ::oPdfPage, 34, ::nLinhaPDF -40, 564, Nil, cTextoCond, HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 11 )
   ENDIF
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 30,  ::nLinhaPDF -14, 284, Nil, 'Local e data', HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 9 )
   hbNFe_Texto_hpdf( ::oPdfPage, 304, ::nLinhaPDF -14, 574, Nil, 'Sem outro motivo para o momento subscrevemos-nos.', HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 9 )
   hbNFe_Texto_hpdf( ::oPdfPage, 304, ::nLinhaPDF -24, 574, Nil, 'Atenciosamente.', HPDF_TALIGN_LEFT, ::oPdfFontCabecalho, 9 )
   ...
   hbNFe_Texto_hpdf( ::oPdfPage, 30,  ::nLinhaPDF -94, 284, Nil,  Trim( MemoLine( ::aDest[ "xNome" ], 40, 1 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 9 )
   hbNFe_Texto_hpdf( ::oPdfPage, 30,  ::nLinhaPDF -108, 284, Nil, Trim( MemoLine( ::aDest[ "xNome" ], 40, 2 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 9 )
   hbNFe_Texto_hpdf( ::oPdfPage, 300, ::nLinhaPDF -94,  574, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 40, 1 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 9 )
   hbNFe_Texto_hpdf( ::oPdfPage, 300, ::nLinhaPDF -108, 574, Nil, Trim( MemoLine( ::aEmit[ "xNome" ], 40, 2 ) ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalho, 9 )
