...
*/
   ...
   IF ::aInfEvento[ "tpEvento" ] == "110110"
      ...
      ::DrawTexto( 296, ::nLinhaPDF -22, 554, Nil, "CARTA DE CORREÇÃO ELETRÔNICA", HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 14 )
   ELSE
...
METHOD Destinatario() CLASS hbnfeDaEvento
   ...
   IF At( "retEventoCTe", ::cXmlEvento ) > 0  // runner
      ::DrawTexto( 30, ::nLinhaPdf, 565, Nil, "DESTINATÁRIO", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ELSE
      ::DrawTexto( 30, ::nLinhaPdf, 565, Nil, "DESTINATÁRIO/REMETENTE", HPDF_TALIGN_LEFT, ::oPdfFontCabecalhoBold, 6 )
   ENDIF
   ::nLinhaPdf -= 9
   // RAZAO SOCIAL
   ...
   ::DrawTexto( 287, ::nLinhaPDF -6, 424, Nil, ::FormataTelefone( ::aDest[ "fone" ] ), HPDF_TALIGN_CENTER, ::oPdfFontCabecalhoBold, 11 )
   // ESTADO
